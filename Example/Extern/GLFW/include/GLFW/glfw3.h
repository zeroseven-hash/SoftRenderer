 ...
 *
 *  @analysis Application m_RendererIdmer error.  Initialize GLFW before calling any
 ...
 *
 *  @analysis Application m_RendererIdmer error.  Ensure a context is current before
 ...
 *
 *  @analysis Application m_RendererIdmer error.  Fix the offending call.
 */
 ...
 *  in the Mac Developer Library.  The GLFW test and example m_RendererIds use
